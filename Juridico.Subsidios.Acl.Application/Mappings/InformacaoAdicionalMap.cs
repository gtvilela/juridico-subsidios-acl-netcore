...
namespace Juridico.Subsidios.Acl.Domain.Mappings
{
    public class InformacaoAdicionalMap : Profile
    {
        ...
        {
            CreateMap<InformacaoAdicionalFornecedorRetornoModel, ProcessoModel>()
            ...
            CreateMap<InformacaoAdicionalProcessoIntegracao, InformacaoAdicionalModel>()
                .ForMember(dest => dest.CodigoTipo, m => m.MapFrom(src => src.Codigo))
            ...
            CreateMap<InformacaoAdicionalModel, InformacaoAdicionalFornecedorEnvioModel>();
        }
    }
}
